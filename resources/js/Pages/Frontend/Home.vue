                ...
                <div class="grid grid-cols-12 lg:gap-12">
                    <div class="col-span-12" id="find-job">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <p class="text-base text-white/60">{{ job_count }}
                                Result{{ job_count > 1 ? "s" : "" }} Found</p>
                        </div>
                        <!-- /Section Header -->
                        <!-- Job Listings -->
                        <div>
                            <template v-if="jobs.data.length">
                                ...
                                <div v-for="job in jobs.data"
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex flex-col items-start gap-6 md:flex-row md:items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-3 flex items-center gap-2">
                                                    <p
                                                        class="w-fit rounded-md bg-gray-300/30 px-2 py-1 text-xs text-white/70">
                                        ...
                                        <Link
                                            class="flex items-center gap-1.5 rounded-lg bg-gray-300/30 px-4 py-2.5 text-indigo-300 transition group-hover:bg-indigo-500 group-hover:text-white group-hover:duration-500"
