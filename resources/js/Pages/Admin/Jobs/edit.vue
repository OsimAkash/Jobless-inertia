                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        form.post( route('admin.jobs.store'))">
                            ...
                            <div>
                                ...
                                <input
                                  v-model="form.title" class='mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-indigo-600 dark:focus:ring-indigo-600'
                            ...
                            <div class="mt-8">
                                ...
                                <input
                                  v-model="form.role" class='mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-indigo-600 dark:focus:ring-indigo-600'
                            ...
                            <div class="mt-8">
                                ...
                                <select
                                    ...
                                    <option value="">Select a type of employment</option>

                                    <option v-for="employmentType in employmentTypes.data"
                                        :value="employmentType.value">
                                        {{ employmentType.label }}</option>
                                </select>
                            ...
                            <div class="mt-8">
                                ...
                                <textarea
                                    ...
                                    placeholder="e.g. Senior Laravel Developer"></textarea>
